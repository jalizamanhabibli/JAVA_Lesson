...
public class UsersController extends HttpServlet {
    ...
    private void editUser(HttpServletRequest request, HttpServletResponse response) {
        ...
        Country birthplace = countryDaoInter.getById(Integer.valueOf(request.getParameter("birthplace")));
        Country nationality = countryDaoInter.getById(Integer.valueOf(request.getParameter("nationality")));
