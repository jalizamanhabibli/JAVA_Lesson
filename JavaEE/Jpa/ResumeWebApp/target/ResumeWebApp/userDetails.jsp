...
<%
    ...
    List<Country> countryList = Context.instanceCountryDao().getAllCountries();
%>
<body>
<div class="container">
    <div class="col-6 m-auto">
        <form action="/resume/" method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="birthday" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(user.getBirthDate())%>">
            </div>
            <div class="form-group">
